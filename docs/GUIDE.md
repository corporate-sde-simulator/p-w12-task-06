...
> **Welcome to Product-Track Week 12, Task 6!**
...
| `src/logAnalyzer.py` | Main source code - **has bugs to fix** |
| `src/logConstants.py` | Supporting code - **may also have bugs** |
| `tests/test_logs.py` | Test file - **add your tests here** |
...
### Incident - `src/logAnalyzer.py`
**User Report / Alert:**
> "(no marker): Regex pattern doesn't handle multi-word log levels"
...
### Incident - `src/logAnalyzer.py`
**User Report / Alert:**
> "(no marker): Case-sensitive comparison — 'error' != 'ERROR'"
...
### Incident - `src/logAnalyzer.py`
**User Report / Alert:**
> "(no marker): Not sorted — returns in insertion order, not chronological"
